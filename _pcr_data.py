...
CHARA_NAME = {
    ...
    # =================================== #
    #恋×シンアイ彼女#
    7020: ['星奏','姫野星奏','HimenoSena','届不到'],
    7021: ['彩音','新堂彩音','ShindouAyane'],
    7022: ['结衣','小鞠ゆい','KomariYui'],
    7023: ['凛香','四條凛香','ShijouRinka'],
    7024: ['精华','森野精華','MorinoSeika'],
    7025: ['菜子','國見菜子','KunimiNako'],
    7026: ['奈津子','如月奈津子','ShiJyouRinka'],
    7027: ['爱美','小鞠愛美','KomariAyumi'],

    # =================================== #
    #喫茶ステラと死神の蝶#
    7030: ['明月栞那','AkizukiKanna','栞那'],
    7031: ['火打谷爱衣','HiuchidaniMei','爱衣','打火机'],
    7032: ['四季夏目','四季ナツメ','ShikiNatsume','夏目'],
    7033: ['墨染希','SumizomeNozomi','小希'],
    7034: ['汐山凉音','ShioyamaSuzune','凉音'],
    
    # =================================== #
    #桜ひとひら恋もよう#
    7040: ['纱矢','上川紗矢','KamikawaSaya'],
    ...
    # =================================== #
    #Clover Day's#
    7050: ['杏铃','鷹倉杏鈴','TakakuraAnzu','杏铃铃','Anzu','呀呀呀'],
    7051: ['杏璃','鷹倉杏璃','TakakuraAnri','杏璃璃','Anri'],
    7052: ['碧瑠','加賀美ヘキル','KagamiHekiru','碧琉'],
    7053: ['光瑠','加賀美ヒカル','KagamiHikaru','光琉'],
    7054: ['燕','竜胆つばめ','RindouTsubame'],
    7055: ['泉','結橋泉','YuibashiIzumi'],
    7056: ['紫苑','乃木坂紫苑','NogisakaShion'],
    # =================================== #
    #あなたに恋する恋愛ルセット#
    7060:['橘乃乃香','橘ののか','TachibanaNonoka','乃乃香'],
    7061:['柚姬','大园柚姬','OozonoYuzuki'],
    7062:['枫花','键由枫花''KagiyoshiFuuka'],
    7063:['美绘瑠','白咲美绘瑠','ShirosakiMieru','不了不了,这伤身体.jpg'],

    # =================================== #
    #晴れのちきっと菜の花びより#
    7070: ['菜乃花','綾崎菜乃花','AyasakiNanoka','晴菜花'],
    7071: ['木乃实','榊野このみ','SasakinoKonomi'],
    7072: ['花梨','小原花梨','ObaraKarin'],
    7073: ['雨音','桜木雨音','SkuragiAmane'],
    7074: ['玲于奈','莲见玲于奈','HasumiReona'],

    #警告:下列角色包含严重剧透,请自行决定是否启用

    7075: ['彩菜','榊野彩菜','SakakinoAyana'],
    7076: ['时雨','Shigure'],
    7077: ['晴乃','Haruno'],
    ...
    #雀魂#
    #以下是普通角色#
    7400: ['白石奈奈','白石奈々','ShiraishiNana','早坂爱','奈奈'],
    ...
    7409: ['三上千织','MikamiChiori','爽哥','假天江衣','千织'],
    ...
    7417: ['北见沙和子','KitamiSawako','北见沙合子','太太','沙和子','沙和尚'],
    7418: ['雏桃','Hinamomo','出逃'],
    7419: ['辉夜','辉夜姬','かぐや姫','KaguyaHime','kaguya'],
