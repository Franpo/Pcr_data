...
CHARA_NAME = {
    ...
    # =================================== #
    #喫茶ステラと死神の蝶#
    7104: ['明月栞那','明月栞那','AkizukiKanna','栞那'],
    7105: ['火打谷爱衣','火打谷愛衣','HiuchidaniMei','爱衣','打火机'],
    7106: ['四季夏目','四季ナツメ','ShikiNatsume','夏目'],
    7107: ['墨染希','墨染希','SumizomeNozomi','小希'],
    7108: ['汐山凉音','汐山涼音','ShioyamaSuzune','凉音'],
